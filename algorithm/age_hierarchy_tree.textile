...
* 'index' is the order of the subpopulation in the leaf layer. The above rule means the youngest level (all leaf nodes) is not restarted completely, instead single nodes are restarted in the round-robin way.
