...
class TC_CrossoverLHS < Test::Unit::TestCase
  ...
  def test_wrapping_bugfix
    c = CrossoverLHS.new
    c.random = MockRand.new [{2=>1}, {5=>3}, {5=>2}]  

    parent1 = [ 2, 1, 0 ] # shorter (due to wrapping)
    # virtual is: [ 2, 1, 0, 2,    1,    0, 2, 1, 0 ]  (3.times wrap)
    ...
    track1 = [
      ...
      Mapper::TrackNode.new( 'expr', 4, 4 ), # this
      Mapper::TrackNode.new( 'aop', 5, 5 ), 
      Mapper::TrackNode.new( 'expr', 6, 6 )
    ]
    ...
    track2 = [
      ...
      Mapper::TrackNode.new( 'expr', 1, 1 ),
      Mapper::TrackNode.new( 'aop', 2, 2 ),
      Mapper::TrackNode.new( 'expr', 3, 6 ), # this
      Mapper::TrackNode.new( 'expr', 4, 4 ),     
      Mapper::TrackNode.new( 'aop', 5, 5 ),     
      Mapper::TrackNode.new( 'expr', 6, 6 ),          
    ]
    ...
    assert_equal( [ 2, 1, 0, 2,    5, 0, 6, 1,    0, 2, 1, 0 ], offspring1 )
    assert_equal( [2, 4, 3,    1,    3, 5], offspring2 ) 
  end
