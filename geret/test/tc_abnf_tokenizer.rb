...
ABNF_TEXT
  ...
  def test_basic
    ...
    assert_equal( Token.new( :slash ), token_stream.shift )
    assert_equal( Token.new( :space ), token_stream.shift )  
    assert_equal( Token.new( :entity_hex, '3f' ), token_stream.shift )   
    assert_equal( Token.new( :dash ), token_stream.shift )  
    assert_equal( Token.new( :entity_hex, 'aB' ), token_stream.shift )   
    assert_equal( Token.new( :space ), token_stream.shift ) 
